<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Editar_Imovel.aspx.cs" Inherits="Interface.Editar_Imovel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pageheader">
        <h2><i class="fa fa-edit"></i>Editar Imovel<span>Edite os campos abaixo...</span></h2>
    </div>
    <!-- -->
    <div class="panel panel-default">
        <div class="panel-body panel-body-nopadding">
            <%--<div class="form-group">
                ...
                <div class="col-sm-1">
                    <asp:TextBox ID="CodImov" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
            </div>--%>

            <div class="form-group">
                <label class="col-sm-3 control-label">Nome Imovel</label>
                <div class="col-sm-6">
                    <asp:TextBox ID="NomeImov" runat="server" CssClass="form-control" ></asp:TextBox>
                    <asp:RequiredFieldValidator runat="server" ID="reqNome" ControlToValidate="NomeImov" ErrorMessage="Por favor escreva o nome do imóvel!" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <asp:RequiredFieldValidator runat="server" ID="reqPreco" ControlToValidate="Preco" ErrorMessage="Por favor escreva o preço do imóvel no padrão R$ 0.000,00!" />
                </div>
            </div>
            <%--<div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    <asp:RequiredFieldValidator runat="server" ID="reqCat" ControlToValidate="ddlCategoria" ErrorMessage="Por favor escolha a categoria!" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">SubCategoria</label>
                <div class="col-sm-5">
                    <asp:DropDownList ID="ddlSubCategoria" runat="server" CssClass="form-control chosen-select"></asp:DropDownList>
                    <asp:RequiredFieldValidator runat="server" ID="ddlSubCat" ControlToValidate="ddlSubCategoria" ErrorMessage="Por favor escolha a subcategoria!" />
                </div>
            </div>
            <%--<div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="fileupload fileupload-new" data-provides="fileupload" style="margin-bottom:30px;">
                        ...
                        <asp:FileUpload ID="IMG" runat="server" CssClass="" />
                    </div>
        ...
        <div class="panel-footer">
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
                    <asp:Button ID="Atualizar" CssClass="btn btn-primary" runat="server" Text="Atualizar" OnClick="Atualizar_Click" />
                </div>
            </div>
        </div>
        <!-- panel-footer -->
